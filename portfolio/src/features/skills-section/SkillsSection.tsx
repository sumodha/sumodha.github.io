...
import CIcon from '../../assets/icons/c_icon.svg?react';
import ROS2Icon from '../../assets/icons/ros2_icon.svg?react';
...
function SkillsSection() {
    return (
        ...
        <div className="skills-frameworks">
            ...
            <Skill icon = {ROS2Icon} title = "ROS2"></Skill>
        ...
        <div className='skills-languages'> 
            ...
            <Skill icon = {CIcon} title = "C/C++, C#"></Skill>
        </div>
        </div>
        <div className = "skills-column">
